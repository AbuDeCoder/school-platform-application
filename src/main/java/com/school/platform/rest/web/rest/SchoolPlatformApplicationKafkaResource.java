...
@RestController
@RequestMapping("/api/school-platform-application-kafka")
public class SchoolPlatformApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(SchoolPlatformApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SchoolPlatformApplicationKafkaResource(KafkaProperties kafkaProperties) {
