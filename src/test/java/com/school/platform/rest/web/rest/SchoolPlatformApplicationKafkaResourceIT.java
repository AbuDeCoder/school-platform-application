...
import com.school.platform.rest.config.KafkaProperties;
...
class SchoolPlatformApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        SchoolPlatformApplicationKafkaResource kafkaResource = new SchoolPlatformApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/school-platform-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/school-platform-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
